...
from nova.api.openstack.compute.contrib import instance_usage
...
class InstanceUsageTest(test.TestCase):
    content_type = 'application/json'
    prefix = 'OS-INST-USG:'

    def setUp(self):
        super(InstanceUsageTest, self).setUp()
        ...
        self.flags(
            ...
            osapi_compute_ext_list=['Instance_usage'])
...
class InstanceUsageXmlTest(InstanceUsageTest):
    content_type = 'application/xml'
    prefix = '{%s}' % instance_usage.Instance_usage.namespace
